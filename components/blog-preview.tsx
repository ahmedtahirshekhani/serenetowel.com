...
  return (
    <section className="py-16 md:py-24 bg-[#f6f4ee] relative overflow-hidden" aria-labelledby="process-heading">
...
          className="mb-12"
        >
          <h3 id="process-heading" className="text-2xl md:text-3xl font-semibold text-[#1C1C1C]">
            Our Process
          </h3>
        </motion.div>

        <div className="max-w-6xl mx-auto relative">
          {/* Guidelines (curves) - CORRECTED SVG PATHS */}
          <svg
            className="pointer-events-none absolute inset-0 hidden lg:block z-0"
            // Adjust viewBox to fit the long, vertical flow of the original design
...
           
            <path
              d="M700 120 C 850 50, 900 200, 500 350 S 100 600, 500 700 S 900 950, 500 1050"
              stroke="#D9DAA8"
              strokeWidth="3"
              fill="none"
              strokeLinecap="round"
...
                    step.id === 2 || step.id === 4 ? 'lg:flex-row-reverse' : ''
                  }`}
                >
                  {/* Text */}
...
                    </h4>
                    <p className="text-base text-[#5A5A5A] leading-7">{step.text}</p>
                  </div>

                  {/* Image (on top of guideline) */}
                  <div className="lg:w-1/2 flex justify-center lg:justify-end relative z-20">
                    <div className="w-[380px] h-[260px] bg-gray-200 rounded-lg overflow-hidden shadow-md">
                      <Image
                        src={step.img}
                        alt={step.title}
                        width={760}
