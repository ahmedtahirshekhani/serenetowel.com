...
export default function ModernFooter() {
  return (
    <footer className="bg-[hsl(0,0%,10%)] border-t border-[hsl(210,9%,46%)] py-8 sm:py-16 px-3 sm:px-6 lg:px-8 text-white">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            <h3 className="text-lg font-bold mb-2 underline underline-offset-4">Quick Links</h3>
          ...
          <div>
            <h3 className="text-lg font-bold mb-2 underline underline-offset-4">Reach Us Out</h3>
            <div className="mt-4 mb-6 flex flex-col gap-2">
              <Link href="mailto:sales@selenetowel.com" className="text-[hsla(0, 0%, 100%, 1.00)] hover:text-[hsl(195,100%,49%)] font-medium underline underline-offset-2">
                sales@selenetowel.com
              </Link>
              <Link href="tel:+923552787275" className="text-[hsla(0, 0%, 100%, 1.00)] hover:text-[hsl(195,100%,49%)] font-medium underline underline-offset-2">
                +92 355-2787-275
              </Link>
            </div>
            <h3 className="text-lg font-bold mb-2 underline underline-offset-4">Address</h3>
